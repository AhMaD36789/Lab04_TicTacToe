     ...
     public class Game
    {
        ...
        public Player Play()
        {
            ...
            while (!CheckForWinner(Board))
            {
                ...
                //Position playerPos = playing.GetPosition(Board);
                //if (Board.GameBoard[playerPos.Row, playerPos.Column] == "X" || Board.GameBoard[playerPos.Row, playerPos.Column] == "O")
                //{
                //    SwitchPlayer();
                //    playing = NextPlayer();
                ...
                //    continue;
                //}
                //Board.GameBoard[playerPos.Row, playerPos.Column] = playing.Marker;

                playing.TakeTurn(Board);
                SwitchPlayer();
                i++;

                if (i == 9 && !CheckForWinner(Board))
                {
                    Console.Clear();
                    Board.DisplayBoard();
